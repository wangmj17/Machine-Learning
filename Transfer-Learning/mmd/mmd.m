...
%   
%   input:
%   sourcefeatures: n*m matrix, where n is the number of data samples, and 
%   m is the dimension of features
%   targetfeatures: n*m matrix, where n is the number of data samples, and 
%   m is the dimension of features
%   sigma: gaussian kernel parameter
%
%   output:
%   dist: the distance between P and Q
%
%   Methods:
