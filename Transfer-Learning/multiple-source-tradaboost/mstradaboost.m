...
%
%  input:
%  source: a 1*n cell, where n is the number of sources, each cell is a struct:
%  source(i).trn.features is a n*m feature matrix, where n is the number of data samples
%  and m is the dimension of features
%  source(i).trn.labels is a n*1 label vector
%  targettrnfeatures: target feature matrix used for training
%  targettrnlabels: target label vector used for training
%  
%  output:
%  hyp,alpha are models and parameters used in prediction     
