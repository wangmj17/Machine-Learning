function [ index ] = selectx(labeledfeatures, labels, unlabeledfeatures  )
...
%   Output: the index of the most informative instance in the unlabeled
%   instances
    ...
    % in case the length of index is larger than 1
    index = index(1);
end
